  ...
  return (
    <header className="flex h-16 justify-center bg-white sm:fixed sm:z-30 sm:h-20 sm:w-full">
      <div className="mx-4 flex w-full items-center sm:max-w-screen-lg">
        ...
        <nav className="fixed bottom-0 left-0 z-30 flex h-16 w-full items-center bg-white sm:static sm:top-0 sm:h-fit sm:max-w-5xl sm:justify-end sm:bg-opacity-0">
          <ul
