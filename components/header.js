          ...
          <div className={`${styles.l_addMargin} ${styles.l_addMaxWidth_xCenter_yColumn} ${styles.l_xAlignSide_yCenter}`}>
            ...
            <nav className={styles.p_nav}>
              <ul className={styles.c_nav_noStyle} id="scroll_nav">
                <li className={`${styles.c_nav_xRight} ${styles.c_mediaOnly}`}><a href="#area_top">Top</a></li>
                <li className={styles.c_nav_xRight}><a href="#area_profile">Profile</a></li>
                <li className={styles.c_nav_xRight}><a href="#area_favorite">Work</a></li>
                <li className={styles.c_nav_xRight}><a href="#">Contact</a></li>
              </ul>
            </nav>
          </div>
        </div>
